...
const CHANGELOG = [
  {
    ...
    changes: [
      ...
      'Автопоиск через 400мс, работает на FBS и FBO складах',
  ...
  },
  {
    version: '1.23.0',
    date: '23.03.2026',
    title: 'Единые переключатели видов для FBS и FBO',
    changes: [
      'FBO склады (ряды/паллеты) получили те же табы «Список / Визуально / Карточки»',
      'Режим «Карточки» для FBO: ряды с паллетами внутри, прогресс-бар заполненности',
  ...
  },
  {
    ...
    changes: [
      ...
      'FBO ряды визуально выровнены с FBS стеллажами',
  ...
  },
  {
    ...
    changes: [
      ...
      'Ранее штуки были только в FBOPage, теперь и в WarehousePage',
    ],
  },
  {
    version: '1.14.0',
  ...
  },
  {
    version: '1.11.0',
    date: '21.03.2026',
    title: 'Визуальные перемещения и FBO',
    changes: [
      'Визуальное перемещение товаров между полками drag-and-drop',
      'Визуализация FBO складов с паллетами и коробками',
      'FBSVisualView и FBOVisualView компоненты',
    ],
  },
  {
    version: '1.10.0',
  ...
  },
  {
    ...
    changes: [
      ...
      'Остаток на полку FBS при завершении',
      'Выбор паллета и FBO склада при создании задачи',
    ],
  },
  {
    version: '1.8.0',
  ...
  },
  {
    ...
    title: 'FBO склады',
    changes: [
      'Управление FBO складами: ряды, паллеты, коробки',
      'Штрих-коды на паллетах',
      'Перемещение товара между FBO и FBS',
    ],
  },
  {
    version: '1.4.0',
